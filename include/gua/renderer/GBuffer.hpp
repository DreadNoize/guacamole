...
class GUA_DLL GBuffer : public RenderTarget {
 public:
  ...
  inline scm::gl::texture_2d_ptr const& get_depth_buffer()  const override { return depth_buffer_read_; }
  ...
  ABuffer& get_abuffer() {return abuffer_;}
 ...
 private:
  ...
  scm::gl::texture_2d_ptr depth_buffer_read_;
  scm::gl::texture_2d_ptr depth_buffer_write_;
